...
const CseEventData = [
  ...
  },
  {
    ...
    description:
      "In this two-player adventure, you and your teammate will solve movie-based clues, each revealing a new part of the story and bringing you closer to a legendary prize. Register with your team leader’s name.",
    event_type: "Competition",
    fee: "10",
    student1: "Amal Roy",
    s1_phone: "8301878607",
  ...
  },
  {
    ...
    name: "Leetcode Test",
    description:
      "Submit efficient code solutions for Leetcode-based questions within the given time.",
    event_type: "Competition",
    fee: "30",
